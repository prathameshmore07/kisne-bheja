              ...
              {payments.length === 0 ? (
                <div className="max-w-md mx-auto space-y-3">
                  ...
                  <p className="text-xs text-muted leading-relaxed">
                    Kisne Bheja is listening for incoming payments. You can either make a test payment via Razorpay, or click &ldquo;Simulate Payment&rdquo; above to test the matching pipeline offline.
                  </p>
                </div>
              ) : (
                <div>
